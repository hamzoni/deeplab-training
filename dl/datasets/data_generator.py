...
from dl import input_preprocess
...
_SCREW = DatasetDescriptor(
    splits_to_sizes={
        'train': 1056,  # num of samples in images/training
        # 'train_aug': 10582,
        # 'trainval': 2913,
        # 'val': 3000,
    },
    num_classes=2,  # background, ignore_label, ignore_label, ie label number +2
    ignore_label=255,
)

_TAQUY = DatasetDescriptor(
    splits_to_sizes={
        'train': 2,  # num of samples in images/training
        # 'train_aug': 10582,
        # 'trainval': 2913,
        # 'val': 3000,
    },
